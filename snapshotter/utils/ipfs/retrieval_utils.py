...
from snapshotter.utils.ipfs.dag_utils import get_dag_block
from snapshotter.utils.models.data_models import BlockRetrievalFlags
from snapshotter.utils.models.data_models import RetrievedDAGBlock
from snapshotter.utils.models.data_models import RetrievedDAGBlockPayload
...
async def retrieve_block_data(
    ...
    """
        ...
        Args:
            ...
            data_flag:int - Refer enum data model `snapshotter.utils.data_models.BlockRetrievalFlags`
    """
