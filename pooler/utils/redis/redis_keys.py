...
failed_query_epochs_redis_q = "failedQueryEpochs:" + settings.namespace + ":{}:{}"

discarded_query_epochs_redis_q = "discardedQueryEpochs:" + settings.namespace + ":{}:{}"

failed_commit_epochs_redis_q = "failedCommitEpochs:" + settings.namespace + ":{}:{}"
...
rpc_json_rpc_calls = "rpc:jsonRpc:" + settings.namespace + ":calls"

rpc_get_event_logs_calls = "rpc:eventLogsCount:" + settings.namespace + ":calls"

rpc_web3_calls = "rpc:web3:" + settings.namespace + ":calls"

rpc_blocknumber_calls = "rpc:blocknumber:" + settings.namespace + ":calls"
