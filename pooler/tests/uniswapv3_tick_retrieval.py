...
def get_uniswapv3_ticks_test():
    ...
    with open('/Users/matthewrivas/programming/Powerloom/pooler/pooler/tests/static/abi/UniswapV3Pool.json') as f:
        univ3_abi = json.load(f)
    with open('/Users/matthewrivas/programming/Powerloom/pooler/pooler/tests/static/abi/UniV3Helper.json') as h:
    ...
    txn_params = override_contract.functions.getTicks(address).build_transaction(
        {'maxFeePerGas': 100000000000, 'maxPriorityFeePerGas': 13318564621, 'gas': 100000000000000},
    )
